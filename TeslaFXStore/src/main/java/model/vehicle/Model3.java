...
public class Model3 extends TeslaVehicle {
    ...
    // Constructor con id
    public Model3(boolean rearWheelDrive, boolean highAutonomy,boolean performance, ObjectId id ,String email, String paint, boolean enhancedAutopilot, boolean fullSelfDrivingCapability, boolean wallConnectorCharge, double price, String model) {
    ...
    // Constructor sin id
    public Model3(boolean rearWheelDrive, boolean highAutonomy,boolean performance, String email, String paint, boolean enhancedAutopilot, boolean fullSelfDrivingCapability, boolean wallConnectorCharge, double price, String model) {
