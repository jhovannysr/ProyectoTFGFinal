...
public class ModelS extends TeslaVehicle {
    private boolean dualMotor; // Dual Motor
    private boolean plaid; // Plaid

    // Constructor con id
    public ModelS(boolean dualMotor, boolean plaid, ObjectId id ,String email, String paint,boolean enhancedAutopilot, boolean fullSelfDrivingCapability, boolean wallConnectorCharge, double price, String model) {
    ...
    // Constructor sin id
    public ModelS(boolean dualMotor, boolean plaid,String email, String paint,boolean enhancedAutopilot, boolean fullSelfDrivingCapability, boolean wallConnectorCharge, double price, String model) {
